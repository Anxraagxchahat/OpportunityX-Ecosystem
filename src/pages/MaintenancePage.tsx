 ...
 *
 * Standalone, backend-independent maintenance page rendered whenever
 * MAINTENANCE_MODE is active.
 */
export const MaintenancePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#09090B] text-[#FAFAFA] p-6 relative overflow-hidden font-sans select-none">
      {/* Ambient glow backgrounds */}
      <div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#FF6B00]/10 rounded-full blur-[100px] pointer-events-none" 
        aria-hidden="true" 
      />
      <div 
        className="absolute inset-0 bg-[radial-gradient(rgba(255,107,0,0.03)_1px,transparent_1px)] bg-[size:32px_32px] pointer-events-none" 
        aria-hidden="true" 
      />
      ...
      <div className="relative z-10 max-w-lg w-full bg-[#121215] border border-[#27272A] rounded-3xl p-8 sm:p-10 text-center shadow-2xl backdrop-blur-xl">
        ...
        <div className="bg-[#18181B] border border-[#27272A] rounded-2xl p-4 text-left mb-6" aria-live="polite">
          <div className="flex items-center justify-between text-xs text-[#FF6B00] font-mono font-bold uppercase mb-2">
            <span className="flex items-center gap-1.5">
              <ShieldCheck className="w-3.5 h-3.5" /> Platform Notice
            </span>
            <span className="text-zinc-500 text-[11px]">OPPX-MAIN</span>
          </div>
        ...
        <div className="mt-8 pt-4 border-t border-[#27272A] text-[11px] font-mono text-zinc-600 flex flex-col gap-0.5">
          <span className="text-zinc-400">OPPX-ECOSYSTEM // PLATFORM ISOLATION</span>
