...
export const ECOSYSTEM_PRODUCTS: EcosystemProduct[] = [
  ...
  },
  {
    ...
    status: 'live',
    isFlagship: false,
    tagline: 'Official certificate & credential verification engine.',
    description:
      'Public, tamper-evident verification portal engineered for recruiters, institutions, and members to instantly authenticate OpportunityX internship certificates, course completion records, fellowships, and official certificates of association without logging in.',
    ...
    capabilities: [
      'Instant certificate lookup by ID or QR',
      'Internship & career credential verification',
      'Course completion & workshop records',
      'Member & co-founder association validation',
    ],
    releaseInfo: 'Production Engine v1.0 Live',
  },
  {
    id: 'resume',
    ...
    status: 'live',
    isFlagship: false,
    tagline: '100% Free, privacy-first & AI-assisted ATS resume architect.',
    description:
      'Production-ready resume workspace engineered for students and developers — build ATS-compliant resumes, improve bullet points with AI, preview pixel-perfect A4 layouts, import from GitHub/PDF/JSON, and export clean PDFs with zero watermarks.',
    ...
    capabilities: [
      'Zero watermarks & 100% free forever',
      'Real-time ATS parsing audit & scoring',
      'AI-powered bullet point & summary writer',
      'A4 multi-page export & GitHub/JSON import',
    ],
    releaseInfo: 'Production Builder v2.0 Live',
  },
  ...
  // ==========================================
  {
    ...
    capabilities: [
      'Interactive career roadmaps & milestones',
      '15+ tech domain tracks & creator guides',
